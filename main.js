...
function createNewPlayer(playerName){
    let items = [
        ...
        new Item("Ice Cream Truck","./img/ice cream.png", 100000,500,0,120,"realState"),
        new Item("House","./img/house.png",20000000,100,0, 32000,"realState"),
        new Item("TownHouse","./img/Townhouse.jpg",40000000,100,0,64000,"realState"),
        new Item("Mansion","./img/mansion.jpg", 250000000,20,0,500000,"realState"),
        new Item("Industrial Space","./img/Industrial Space.jpg",1000000000,10,0,2200000,"realState"),
